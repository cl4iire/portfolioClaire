...
const project: ProjectData = {
  ...
  description: {
    FR: "Nous y rencontrons Alice, une jeune femme qui mène une vie confortable mais monotone dans une grande ville. Un jour, elle décide de relâcher son poisson rouge et se lance alors dans un périple à la fois littéral et métaphorique, de la ville à la campagne.",
