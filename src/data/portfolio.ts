...
export const TRANSLATIONS = {
  FR: {
    ...
    teachingsList: [
      ...
      "Cinématographie intermédiaire et post-production",
  ...
  ENG: {
    ...
    teachingsList: [
      ...
      "Intermediate Cinematography and Post‑Production",
